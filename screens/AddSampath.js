...
const AddSampath = () => {
  ...
  return (
    <ScrollView  contentContainerStyle={[styles.scrollViewContent,styles.updateBankProfile]}>
      ...
      />
      <View 
      style={[styles.updateBankProfileChild,styles.scrollViewContent]} />
      ...
      <TextInput
            style={[styles.sampathBranchname, styles.text1Clr]}
      ...
      <TextInput
            style={[styles.sampathaccount, styles.text1Clr]}
